...
-(void)initMyBigImageListUI{
    ...
    [_selectBtn setBackgroundImage:[UIImage imageNamed:@"imageState_Nor"] forState:UIControlStateNormal];
    [_selectBtn setBackgroundImage:[UIImage imageNamed:@"imageState_Sel"] forState:UIControlStateSelected];
    ...
    [backBtn setBackgroundImage:[UIImage imageNamed:@"back_press"] forState:UIControlStateNormal];
